...
const GRUOptions = (props : any) => 
{
    ...
    <div className = "w-[80px]">
        ...
        <div className = 'flex flex-row w-full items-center justify-center p-1 text-[10px]'>   
            ...
            <input id = {`${props.id}_seq2seq`} type = 'checkbox' checked = {props.seq2seq} onChange = {() => props.setBias(!props.seq2seq)}></input>
        </div>
    </div>)
}
export default GRUOptions